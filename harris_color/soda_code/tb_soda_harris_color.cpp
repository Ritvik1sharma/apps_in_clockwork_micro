...
int main() {
  ...
  harris_color_kernel(hw_output_global_wrapper_stencil_clkwrk_6, hw_output_global_wrapper_stencil_clkwrk_7, hw_input_stencil_clkwrk_0, hw_input_stencil_clkwrk_1, hw_input_stencil_clkwrk_2, hw_input_stencil_clkwrk_3, hw_input_stencil_clkwrk_4, hw_input_stencil_clkwrk_5, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_harris_color_regression_result.csv", hw_output_global_wrapper_stencil_clkwrk_6, nrows, ncols, transfer_cols);
  write_results_decimal<bits_per_pixel>("soda_harris_color_regression_result.csv", hw_output_global_wrapper_stencil_clkwrk_7, nrows, ncols, transfer_cols);
