...
int main() {
  ...
  mobilenet_kernel(hw_output_stencil_clkwrk_10, hw_output_stencil_clkwrk_8, hw_output_stencil_clkwrk_9, hw_filter_dw_stencil_clkwrk_0, hw_filter_dw_stencil_clkwrk_1, hw_filter_dw_stencil_clkwrk_2, hw_filter_dw_stencil_clkwrk_3, hw_filter_pw_stencil, hw_input_stencil_clkwrk_4, hw_input_stencil_clkwrk_5, hw_input_stencil_clkwrk_6, hw_input_stencil_clkwrk_7, num_transfers);
  write_results_decimal<bits_per_pixel>("soda_mobilenet_regression_result.csv", hw_output_stencil_clkwrk_10, nrows, ncols, transfer_cols);
  write_results_decimal<bits_per_pixel>("soda_mobilenet_regression_result.csv", hw_output_stencil_clkwrk_8, nrows, ncols, transfer_cols);
  write_results_decimal<bits_per_pixel>("soda_mobilenet_regression_result.csv", hw_output_stencil_clkwrk_9, nrows, ncols, transfer_cols);
