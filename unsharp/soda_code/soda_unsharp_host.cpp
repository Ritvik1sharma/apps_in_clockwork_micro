...
int main(int argc, char **argv) {
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(2, op_hcompute_hw_output_global_wrapper_stencil_3_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(3, op_hcompute_hw_output_global_wrapper_stencil_4_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(4, op_hcompute_hw_output_global_wrapper_stencil_5_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(5, op_hcompute_hw_output_global_wrapper_stencil_6_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(6, op_hcompute_hw_output_global_wrapper_stencil_7_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(7, op_hcompute_hw_output_global_wrapper_stencil_8_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(8, op_hcompute_hw_output_global_wrapper_stencil_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(9, op_hcompute_hw_input_global_wrapper_glb_stencil_1_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(10, op_hcompute_hw_input_global_wrapper_glb_stencil_2_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(11, op_hcompute_hw_input_global_wrapper_glb_stencil_3_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(12, op_hcompute_hw_input_global_wrapper_glb_stencil_4_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(13, op_hcompute_hw_input_global_wrapper_glb_stencil_5_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(14, op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(15, op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(16, op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(17, op_hcompute_hw_input_global_wrapper_glb_stencil_read_pipe0_ocl_buf));

  uint64_t transfer_size = num_epochs*(0 / 1);
  OCL_CHECK(err, err = krnl_vector_add.setArg(18, transfer_size));
