...
int main(int argc, char **argv) {
  ...
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_read_pipe0_DATA_SIZE = num_epochs*1728;
  ...
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_1_read_pipe0_DATA_SIZE = num_epochs*1728;
  ...
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_2_read_pipe0_DATA_SIZE = num_epochs*1728;
  ...
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_3_read_pipe0_DATA_SIZE = num_epochs*1728;
  ...
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_4_read_pipe0_DATA_SIZE = num_epochs*1728;
  ...
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_5_read_pipe0_DATA_SIZE = num_epochs*1728;
  ...
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_DATA_SIZE = num_epochs*1728;
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_BYTES_PER_PIXEL = 16 / 8;
  size_t op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_size_bytes = op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_BYTES_PER_PIXEL * op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_DATA_SIZE;

  total_size_bytes += op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_size_bytes;
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_DATA_SIZE = num_epochs*1728;
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_BYTES_PER_PIXEL = 16 / 8;
  size_t op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_size_bytes = op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_BYTES_PER_PIXEL * op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_DATA_SIZE;

  total_size_bytes += op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_size_bytes;
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_DATA_SIZE = num_epochs*1728;
  const int op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_BYTES_PER_PIXEL = 16 / 8;
  size_t op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_size_bytes = op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_BYTES_PER_PIXEL * op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_DATA_SIZE;

  total_size_bytes += op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_size_bytes;
  const int op_hcompute_hw_output_global_wrapper_stencil_1_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_2_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_3_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_4_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_5_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_6_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_7_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_8_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  const int op_hcompute_hw_output_global_wrapper_stencil_write_pipe0_DATA_SIZE = num_epochs*1452;
  ...
  std::vector<uint8_t, aligned_allocator<uint8_t> > op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0(op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_size_bytes);
  std::vector<uint8_t, aligned_allocator<uint8_t> > op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0(op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_size_bytes);
  std::vector<uint8_t, aligned_allocator<uint8_t> > op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0(op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_size_bytes);
  ...
  for (unsigned int i = 0; i < devices.size(); i++) {
    ...
    if (err != CL_SUCCESS) {
      ...
      OCL_CHECK(err, krnl_vector_add = cl::Kernel(program, "unsharp_accel", &err));
      valid_device++;
      break;
    }
  }
  ...
  OCL_CHECK(err, cl::Buffer op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_size_bytes, op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(5, op_hcompute_hw_input_global_wrapper_glb_stencil_6_read_pipe0_ocl_buf));

  OCL_CHECK(err, cl::Buffer op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_size_bytes, op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(6, op_hcompute_hw_input_global_wrapper_glb_stencil_7_read_pipe0_ocl_buf));

  OCL_CHECK(err, cl::Buffer op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_ocl_buf(context, CL_MEM_USE_HOST_PTR | CL_MEM_WRITE_ONLY, op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_size_bytes, op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0.data(), &err));
  OCL_CHECK(err, err = krnl_vector_add.setArg(7, op_hcompute_hw_input_global_wrapper_glb_stencil_8_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(8, op_hcompute_hw_input_global_wrapper_glb_stencil_read_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(9, op_hcompute_hw_output_global_wrapper_stencil_1_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(10, op_hcompute_hw_output_global_wrapper_stencil_2_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(11, op_hcompute_hw_output_global_wrapper_stencil_3_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(12, op_hcompute_hw_output_global_wrapper_stencil_4_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(13, op_hcompute_hw_output_global_wrapper_stencil_5_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(14, op_hcompute_hw_output_global_wrapper_stencil_6_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(15, op_hcompute_hw_output_global_wrapper_stencil_7_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(16, op_hcompute_hw_output_global_wrapper_stencil_8_write_pipe0_ocl_buf));
  ...
  OCL_CHECK(err, err = krnl_vector_add.setArg(17, op_hcompute_hw_output_global_wrapper_stencil_write_pipe0_ocl_buf));


  OCL_CHECK(err, err = krnl_vector_add.setArg(18, num_epochs));
